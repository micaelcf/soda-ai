...
export default function MainLayout() {
  ...
  return (
    <div className="min-h-dvh bg-gray-900 text-gray-50">
      ...
      <div className="flex">
        {/* Sidebar - Desktop */}
        <nav className="hidden md:block w-64 bg-gray-800 border-r border-gray-700 min-h-[calc(100vh-80px)]">
          <div className="p-4">
              ...
              <div className="p-4">
                ...
                <div className="flex items-center space-x-2 mb-6 p-3 bg-gray-700 rounded-lg">
                  ...
                  <input
                    ...
                    className="flex-1 px-2 py-1 bg-gray-600 border border-gray-500 rounded text-gray-50 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                <ul className="space-y-2">
                  {navigation.map((item) => (
